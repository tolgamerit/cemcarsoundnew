...
<head>
  ...
  <title><?php echo $query['site_name']; ?> | Adana da navigasyon montajı ve tamiri</title>
    ...
    <div class="container mt-5 mb-5">
        <div class="row mt-5">
            ...
            <div class="col-md-9 text-left">
                    ...
                    <h2 class="mb-5">Adana da navigasyon montajı ve tamiri
                    </h2>
    <div class="row">
        <div class="col-md-7 ">
            <p >
                Cem Car Sound ailesi olarak her marka navigasyon satış ve montajı konusunda deneyimli ve uzman kadromuz ile hizmet vermekteyiz. Cylone, Convex, Naviin, Necvox, Navsmart, Navnet, Navix, Avt, Navimaster, Pioneer, Kenwood, Newfron, Massive, Sound Magus, Focal, Hertz, Jbl, Kicker ve daha bir çok markayı siz degerli müşterilerimiz satış mağazamızda bulabilirsiniz. Multimedya navigasyongeri görüş kamerası taktırmak istediğinizde lütfen önce bize danışın. Düşük masraflarla da aracınız kaliteli bir görünüme sahip olabilir. </p>
        </div>
        <div class="col-md-5">
            <img class="img-fluid wow fadeInRight" src="img/front3.jpg" alt="">
