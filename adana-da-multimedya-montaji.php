...
<head>
  ...
  <title><?php echo $query['site_name']; ?> | Adana da multimedya montajı</title>
    ...
    <div class="container mt-5 mb-5">
        <div class="row mt-5">
            ...
            <div class="col-md-9 text-left">
                    ...
                    <h2 class="mb-5">Adana da multimedya montajı
                    </h2>
    <div class="row">
        <div class="col-md-7 ">
            <p >Cem Car Sound ailesi olarak multimedya satış ve montajı konusunda deneyimli ve uzman kadromuz ile hizmet vermekteyiz. Her marka aracınız için ürün çeşitlerimizi kaliteli ve dayanıklı tutmaya gayret göstermekteyiz. Aracınıza multimedya sistemi yaptırmak istediğinizde lütfen önce bize danışın. Düşük masraflarla da aracınız kaliteli bir görünüme sahip olabilir.</p>
        </div>
        <div class="col-md-5">
            <img class="img-fluid wow fadeInRight" src="img/front2.jpg" alt="">
